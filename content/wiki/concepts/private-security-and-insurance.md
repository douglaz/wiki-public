...
- **The Market for Liberty (Full Text Aggregate)** - most detailed account of defense agencies, policing functions, and the role of insurance
- **The Economics and Ethics of Private Property (Full Text Aggregate)** - theoretical case for competitive security production and insurance-based discipline
- **A Theory of Socialism and Capitalism (Full Text Aggregate)** - property-theoretic route from ownership to private police and courts
- **For a New Liberty: The Libertarian Manifesto (Full Text Aggregate)** - Rothbard's broader political framing for non-state protection
- **The Production of Security (Full Text Aggregate)** - Molinari's 1849 founding statement of the private-security thesis
